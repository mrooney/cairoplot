...
#CairoPlot.bar_plot ('bar', data, 400, 300, border = 10)
...
CairoPlot.pizza_plot("pizza_teste", teste_data, 200, 200)
...
#CairoPlot.gantt_chart('gantt_teste', pieces, 500, 350, h_legend, v_legend, colors)
